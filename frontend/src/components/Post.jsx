    ...
    <div onClick={() => openPost(post.id)}>
      <li className="post-card">
        <div className="post-meta">
          <Avatar avatarKey={post.avatarKey} avatarUrl={post.avatarUrl } size={36} username={post.username} userId={post.userId}/>
        ...
        <div className="post-stats">❤️ {post.likes || 0} &nbsp;•&nbsp; 💬 {post.comment || 0}</div>
      </li>
    </div>
  )
}
